...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
      ...
      {/* CHANGED: h-16 → h-[var(--header-height)] */}
      <header className="bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-[var(--header-height)] hidden md:flex items-center justify-between relative">

          <div className="w-[240px] invisible lg:block" aria-hidden="true" />
          ...
          <div className="flex items-center gap-12 mx-auto">
            ...
            <Link href={localizedHref("/")} className="relative w-14 h-14 shrink-0">
              <Image
                src="/images/logo.jpg"
                alt="Enteg Voyage"
                fill
          ...
          <div className="flex items-center gap-6 min-w-[240px] justify-end">
            ...
            <Link
              ...
              className="bg-[#b07018] text-white text-xs font-bold uppercase tracking-wider px-6 py-2.5 rounded-lg hover:bg-opacity-90 transition-colors duration-300"
            >
              CONTACT
            </Link>
          </div>
        ...
        <div className="md:hidden flex items-center justify-between px-6 py-2.5">
          <Link href={localizedHref("/")} className="relative w-12 h-12">
            <Image
              src="/images/logo.jpg"
              alt="Enteg Voyage"
              fill
