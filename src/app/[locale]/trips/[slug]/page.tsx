    ...
    <div className="pt-24 pb-20">
      ...
      <div className="max-w-5xl mx-auto px-6 mt-12 grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2">
          <h2 className="text-2xl font-bold text-[var(--night)] mb-4">Ce qui est inclus</h2>
          ...
          <h2 className="text-2xl font-bold text-[var(--night)] mt-10 mb-4">Destinations</h2>
          <div className="flex flex-wrap gap-2">
            {trip.destinations.map((d) => (
              <span key={d} className="bg-white border border-[var(--sand)] text-[var(--night)] text-sm px-4 py-2 rounded-full">
                {d}
              </span>
            ))}
          </div>
